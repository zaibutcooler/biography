...
<div class="fixed left-0 top-0 -z-50">
	<div class="sticky left-0 top-0 h-screen w-screen overflow-hidden">
		...
		<div
			class={`absolute bg-gradient-radial left-[${x}] top-[${y}] z-[-1] h-56 w-56 -translate-x-1/2 -translate-y-1/2 rounded-full from-muted-foreground/50 from-0% to-transparent to-90% blur-md`}
		/>
